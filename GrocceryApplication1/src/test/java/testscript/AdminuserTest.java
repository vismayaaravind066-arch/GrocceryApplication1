...
public class AdminuserTest extends Base {
	...
	public void verifyUserAbleToAddNewAdminUser() throws IOException {
		...
		adminpage.enterUsernameOnUsernameField(username1).enterPasswordOnPasswordField(password1).selectingUserType()
				.ClickOnSaveButton();
	...
	public void verifyUserAbleToSearchNewlyAddedAdminUser() throws IOException {
		...
		adminpage.enterUsernameOnSearchAdminUsers(username1).selectUserTypeOnSearchAdminUser()
				.clickOnSearchButtonOnAdminSeachUser();
